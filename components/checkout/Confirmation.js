    ...
    return (
        <div className='Confirmation'>
            <div className='Confirmation__details'>
                ...
                <h1 className='heading--2'><span>THANK YOU</span> FOR YOUR ORDER</h1>
                ...
                <div className='Confirmation__summary'>
                    <div className='Confirmation__items'>
                        ...
                        {cart.length === 1 ? null : <button type='button' className='Confirmation__btn' onClick={isLess ? viewMore : viewLess}>{isLess ? `View More(+${cart.length - 1})` : 'View Less'} </button>}
                    </div>
