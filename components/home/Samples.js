        ...
        <div className='Samples'>
            <div className='Samples__ZX9'>
                ...
                <div className='Samples__ZX9__content'>
                    ...
                    <Btn cls='black' href='speakers/zx9-speaker' text='SEE PRODUCT' />
                </div>
            </div>
            ...
            <div className='Samples__ZX7'>
                ...
                <div className='Samples__ZX7__content'>
                    ...
                    <Btn cls='transparent' href='speakers/zx7-speaker' text='SEE PRODUCT' />
                </div>
            </div>
            <div className='Samples__YX1'>
                ...
                <div className='Samples__YX1__content'>
                    ...
                    <Btn cls='transparent' href='earphones/yx1-earphones' text='SEE PRODUCT' />
                </div>
            </div>
        </div>
    )
