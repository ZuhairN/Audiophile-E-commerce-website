            ...
            <div className='Footer__container'>
                ...
                <div className='Footer__content'>
                    ...
                    <div className='Footer__media'>
                        <a href='https://twitter.com/' target='_blank' rel="noreferrer" aria-label='Visit our Twitter page'><FaTwitter /></a>
                        <a href='https://www.facebook.com/' target='_blank' rel="noreferrer" aria-label='Visit our Facebook page'><FaFacebookSquare /></a>
                        <a href='https://www.instagram.com/' target='_blank' rel="noreferrer" aria-label='Visit our Instagram page'><FaInstagram /></a>
                    </div>
                </div>
            </div>
        </footer>
